...
The following is an example implementation of custom `RootLayout` React Server Component that uses `getTokens` function to create user object based on user cookies and pass it down to `AuthProvider` client component.
