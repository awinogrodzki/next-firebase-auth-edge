...
3. Allows to customize routing behaviour by defining `handleValidToken`, `handleInvalidToken` and `handleError` callbacks. [See Authentication Middleware usage docs](/docs/usage/middleware)
