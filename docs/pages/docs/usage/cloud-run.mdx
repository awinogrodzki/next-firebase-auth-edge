...
If you run your app outside Google Cloud and cannot use service account keys, see [Usage with Workload Identity Federation](/docs/usage/workload-identity-federation).
