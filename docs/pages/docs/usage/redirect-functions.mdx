...
`redirectToLogin` is used to redirect unauthenticated users to a public authentication page. It also skips redirect in case a request matches one of provided `publicPaths`.
