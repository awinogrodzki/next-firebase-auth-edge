...
| Name                           | Type                                                                                                                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| getCustomIdAndRefreshTokens    | `(idToken: string, options?: {appCheckToken?: string, referer?: string}) => Promise<IdAndRefreshTokens>`                                         | Generates a new set of id and refresh tokens for user identified by provided `idToken`. Accepts optional `appCheckToken` as an option. You should pass it if your app supports [App Check](https://firebase.google.com/docs/app-check). You can use `referer` option if your api key is restricted by a domain                                                                                                              |
...
| verifyAndRefreshExpiredIdToken | `(token: string, refreshToken: string,  options?: {checkRevoked?: boolean, referer?: string, currentDate?: Date}) => Promise<VerifyTokenResult>` | Verifies provided `idToken`. If token is expired, uses `refreshToken` to validate it. Throws `InvalidTokenError` if credentials are missing or malformed. Available options are the same as in `verifyIdToken` method                                                                                                                                                                                                       |
...
| handleTokenRefresh             | `(refreshToken: string, options?: {referer?: string}) => Promise<VerifyTokenResult>`                                                             | Returns id `token` and `decodedToken` for given `refreshToken`. `referer` should be passed if api key is restricted by a domain                                                                                                                                                                                                                                                                                             |
