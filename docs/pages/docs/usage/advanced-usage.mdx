...
| ------------------------------ | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| getCustomIdAndRefreshTokens    | `(idToken: string, appCheckToken?: string) => Promise<IdAndRefreshTokens>` | Generates a new set of id and refresh tokens for user identified by provided `idToken`. Accepts optional `appCheckToken` as a third argument. You should pass it if your app supports [App Check](https://firebase.google.com/docs/app-check) |
